...
*/
    ...
    public async loadPolicy(model): Promise<any> {
        return new Promise((resolve, reason)=> {
            this.redisInstance.get("policies", (err, policies) => {
                ...
                if (!err) {
                    ...
                    console.log(policies);
                    Object.keys(policies).forEach((policy, index)=> {
    ...
    public async loadFilteredPolicy(model: Model, filter: any): Promise<any> {
    ...
    async savePolicy(model): Promise<any>{
    ...
    async removeFilteredPolicy(sec, ptype, fieldIndex, ...fieldValues): Promise<any> {
